...
export const Footer = () => {
  return (
    <footer className="bg-white py-12 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 border-t border-gray-200">
      <div className="max-w-7xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          {/* Column 2: Product */}
          <div className="text-center sm:text-left">
            <h4 className="text-sm font-bold mb-4 uppercase tracking-wider text-gray-900">Producto</h4>
          ...
          {/* Column 3: Company */}
          <div className="text-center sm:text-left">
            <h4 className="text-sm font-bold mb-4 uppercase tracking-wider text-gray-900">Empresa</h4>
            <ul className="space-y-2 text-sm text-gray-600">
          ...
          {/* Column 4: Legal */}
          <div className="text-center sm:text-left">
            <h4 className="text-sm font-bold mb-4 uppercase tracking-wider text-gray-900">Legal</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li><a href="#" className="hover:text-blue-600 transition-colors">Accesibilidad</a></li>
            </ul>
          </div>
        </div>
